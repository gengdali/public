...
public class HuaWeiSMSUtil {
    ...
    public static void main(String[] args) throws Exception {
        //sendSms("[\""+ 147258 +"\"]","13821987022");
        //sendSms(num().toString(), "13821987022");
        sendSms("156666", "13821987022");
    }
     ...
     * @throws Exception
     */
    public static void sendSms(String code, String phone) throws IOException, KeyStoreException, NoSuchAlgorithmException, KeyManagementException {
        ...
        String appKey = "j861V571FwZW5a068t5M3u9M8a4x"; //APP_Key
        String appSecret = "b2GRrHBtskEeV7Kj18OQmWrsDPwZ"; //APP_Secret  99200620888880005856
        String sender = "8823101106735";
        String templateId = "0568f757bcb34f668ad21bfbbd4fd33b";//b664317c20074bee9433af59ca1b1ad1
        ...
        System.out.println("响应头域信息:" + response.toString()); //打印响应头域信息
        System.out.println("响应消息实体" + EntityUtils.toString(response.getEntity())); //打印响应消息实体
    }
