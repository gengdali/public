...
/**
 * @PROJECT_NAME: public
 * @DESCRIPTION:几何对象构建器单例模式
 * @AUTHOR: 12615
 * @DATE: 2024/1/5 14:20
 */
public class GeometryCreatorUtils {

    public static GeometryCreatorUtils geometryCreator = null;

    private GeometryFactory geometryFactory = new GeometryFactory();

    public GeometryCreatorUtils() {
    }
     ...
     * @return
     */
    public static GeometryCreatorUtils getInstance() {
        if (geometryCreator == null) {
            return new GeometryCreatorUtils();
        }
